...
const config: Config = {
  ...
  theme: {
    extend: {
      // Color system: red, gold, light blue, white
      colors: {
        // Primary - light blue
        brand: {
          50: '#f0f9ff',
        ...
        // Surface colors - rich dark tones
        surface: {
          50: '#fafafa',
          100: '#f4f4f5',
          200: '#e4e4e7',
      ...
      backgroundImage: {
        ...
        "glow-gold": "radial-gradient(ellipse at center, rgba(234, 179, 8, 0.1) 0%, transparent 70%)",
        // Classic film grain texture (subtle)
      ...
      boxShadow: {
        // Elegant glow shadows - light blue
      ...
      keyframes: {
        'glow-pulse': {
          '0%': { boxShadow: '0 0 15px -3px rgba(14, 165, 233, 0.3)' },
          '100%': { boxShadow: '0 0 25px -3px rgba(14, 165, 233, 0.5)' },
        },
        'fade-in': {
          '0%': { opacity: '0' },
          '100%': { opacity: '1' },
